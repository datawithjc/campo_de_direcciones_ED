# 🧭 Campo de Direcciones — Observatorio de Ecuaciones Diferenciales
...
Recurso educativo abierto desarrollado para el curso de **Ecuaciones Diferenciales** de la **Universidad Nacional Abierta y a Distancia (UNAD)**.
...
- **Curvas solución exactas**: integración numérica **Runge–Kutta de 4.º orden (RK4)**, bidireccional. Basta hacer **clic** en cualquier punto del plano para trazar la curva que pasa por él.
...
- Logo institucional UNAD incrustado (un único archivo, sin dependencias locales).
...
Recurso educativo abierto. Puede usarse, adaptarse y redistribuirse libremente con fines académicos.
